...
class IteratorSettings(_object):
    ...
    SEARCH_FLOOR = _ifcopenshell_wrapper.IteratorSettings_SEARCH_FLOOR
    ...
    def get(self, setting):
        """get(IteratorSettings self, unsigned int setting) -> bool"""
        return _ifcopenshell_wrapper.IteratorSettings_get(self, setting)


    def set(self, setting, value):
        """set(IteratorSettings self, unsigned int setting, bool value)"""
...
class Triangulation(Representation):
    ...
    def __init__(self, shape_model):
        ...
        this = _ifcopenshell_wrapper.new_Triangulation(shape_model)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
class SvgSerializer(GeometrySerializer):
    ...
    def write(self, *args):
        ...
        write(SvgSerializer self, SvgSerializer::path_object & p, TopoDS_Wire const & wire, boost::optional< std::vector< double,std::allocator< double > > > dash_array)
        write(SvgSerializer self, SvgSerializer::path_object & p, TopoDS_Wire const & wire)
    ...
    def setSectionHeightsFromStoreys(self, offset=1.):
        """
        setSectionHeightsFromStoreys(SvgSerializer self, double offset=1.)
...
class WaveFrontOBJSerializer(GeometrySerializer):
